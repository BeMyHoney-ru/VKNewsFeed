...
//  VKNewsFeed
//
//  Created by Михаил Емельянов on 27/06/2019.
...
final class NewsFeedCodeCell: UITableViewCell {
    ...
    let nameLabel: UILabel = {
        ...
        label.textColor = #colorLiteral(red: 0.2274509804, green: 0.231372549, blue: 0.2352941176, alpha: 0.9153554137)
        return label
    }()
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        overlayFourthLayerOnBottomViewViews() // четвёртый слой на bottomViewViews
    }
